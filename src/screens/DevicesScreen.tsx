...
const DevicesScreen = ({navigation}: Props) => {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity
        ...
        <Text style={styles.myparraph}>Dispositivo 1</Text>
      </TouchableOpacity>
      <TouchableOpacity
        style={styles.myhouse}
        onPress={() => navigation.navigate('AddScenaryScreen')}>
        <Text style={styles.myparraph}>Dispositivo 2</Text>
      </TouchableOpacity>
      <TouchableOpacity
        ...
        <Text>Agregar un Nuevo Dispositivo</Text>
      </TouchableOpacity>
    </View>
  );
};
